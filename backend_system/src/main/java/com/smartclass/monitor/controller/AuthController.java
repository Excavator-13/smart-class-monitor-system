...
import com.smartclass.monitor.dto.RegisterRequest;
...
public class AuthController {
    ...
    @Operation(summary = "用户注册", description = "注册新用户，返回 JWT Token 和用户信息")
    public ApiResponse<LoginResponse> register(@Valid @RequestBody RegisterRequest request) {
        LoginResponse result = authService.register(request.getUsername(), request.getPassword(), request.getNickname());
        return ApiResponse.success(result);
    }
